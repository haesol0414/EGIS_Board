...
public interface BoardService {
    ...
    // 게시글 목록 조회
    Map<String, Object> getBoardList(String filter, String keyword, int size, int offset);
    ...
    // 답글 작성
    Long addReply(Long parentBoardNo, BoardReplyDTO boardReplyDTO, List<MultipartFile> files);
